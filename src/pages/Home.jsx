    ...
    <div className="top-image">
      ...
      <div className="grid gap-6 text-center md:grid-cols-3 lg:gap-12">
        <div className="mb-12 md:mb-0">
          ...
          <h5 className="mb-4 text-xl font-semibold">Chloe</h5>
          ...
          <p className="mb-4 text-neutral-600 dark:text-neutral-300" id="text-font">
            ...
            "Working with Dale was a pleasure, he was able to translate requirments into simple designs which enabled me to create effective websites for customers.""
          </p>
        ...
        <div className="mb-12 md:mb-0">
          ...
          <h5 className="mb-4 text-xl font-semibold">Nigella</h5>
          <h6 className="mb-4 font-semibold text-primary dark:text-primary-400">
            Graphic Designer
          </h6>
          <p className="mb-4 text-neutral-600 dark:text-neutral-300" id="text-font">
            ...
            "In my time working with Dale, he was one of the top performing consultants making sure our projects got completed on time and within budget."
          </p>
          <ul className="mb-0 flex items-center justify-center">
            <li>
              <svg
